...
- [Link](../presentations/tutorial02/index.html) to interactive slides.
...
*   Follow a same core set of command line arguments:
...
[`Connectome Mapper 3 (CMP3)`](https://github.com/connectomicslab/connectomemapper3) is an open-source Python3 image processing pipeline software developed for use within our [Sinergia Consortium Project](https://sinergiaconsortium.bitbucket.io/) as well as for open-source software distribution.
