...
>
> If not, we recommend you to follow the lesson for [the unix shell](https://swcarpentry.github.io/shell-novice/) and for [Programming in Python](https://swcarpentry.github.io/python-novice-inflammation/) made by Software Carpentry.
>
