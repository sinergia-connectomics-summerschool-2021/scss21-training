...
<p>
    <img src="https://bids.neuroimaging.io/assets/img/dicom-reorganization-transparent-white_1000x477.png" style="width: 70%">
</p>
...
The dataset that will be used in this tutorial and throughout most of the tutorials of the summer school consists of a sample of the [VEPCON dataset](https://openneuro.org/datasets/ds003505/versions/1.0.2), a multimodal neuroimaging dataset created by our consortium.
...
│   └── eeg
│       ├── sub-01_coordsystem.json         -> Specifies the coordinate system and units, the fiducials, and the location of anatomical landmarks
│       ├── sub-01_electrodes.tsv           -> Location of each electrode in the coordinate system and units described in _coordsystem.json file 
